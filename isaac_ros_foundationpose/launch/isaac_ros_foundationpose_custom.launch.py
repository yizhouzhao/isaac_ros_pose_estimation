...
class IsaacROSFoundationPoseLaunchFragment(IsaacROSLaunchFragment):
    ...
    @staticmethod
    def get_composable_nodes() -> List[ComposableNode]:

        # Drop node parameters
        input_images_expect_freq = INPUT_IMAGES_EXPECT_FREQ
        input_images_drop_freq = INPUT_IMAGES_DROP_FREQ
    ...
    def get_launch_actions() -> \
            List[launch.actions.OpaqueFunction]:
...
def generate_launch_description():
    launch_args = IsaacROSFoundationPoseLaunchFragment.get_launch_actions()
